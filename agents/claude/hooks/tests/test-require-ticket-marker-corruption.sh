...
run_hook "$SESSION" 'cat agents/claude/ticket-register | grep url'
...
run_hook "$SESSION" 'cat agents/claude/ticket-register'
...
run_hook "$SESSION" '"$HOME/.claude-shared/ticket-register" "'"$NEW_URL"'"'
...
run_hook "$SESSION" '"$HOME/.claude-shared/ticket-register" "'"$CHAINED_URL"'" ; echo done'
...
run_hook "$SESSION" '"$HOME/.claude-shared/ticket-register" ; echo done'
assert_marker "ticket-register with no argument" "$CHAINED_URL" "$STATE_DIR/$SESSION.ticket"

run_hook "$SESSION" '"$HOME/.claude-shared/ticket-register" not-a-url'
