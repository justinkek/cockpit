...
run_ticket_hook "$SESSION" '"$HOME/.claude-shared/ticket-register-type" ticket "a session name" feature'
...
run_ticket_hook "$SESSION" '"$HOME/.claude-shared/ticket-register-source-ticket" https://app.notion.com/p/unquoted1'
...
rm -f "$STATE_DIR/$SESSION.type"
run_ticket_hook "$SESSION" '"$HOME/.claude-shared/ticket-register-type" ticket "[x] ticket-register-type drops the ticket type when unquoted" bug'
...
run_ticket_hook "$SESSION" '"$HOME/.claude-shared/ticket-register-column" "In Dev on ticket-register-column"'
...
run_ticket_hook "$SESSION" '"$HOME/.claude-shared/ticket-register" "https://app.notion.com/p/ticket-register-lookalike"'
...
rm -f "$STATE_DIR/$SESSION.type"
run_ticket_hook "$SESSION" '"$HOME/.claude-shared/ticket-register-type" ticket "a session name" && echo feature'
...
: > "$TRANSCRIPT"
run_rename_hook "$SESSION-rename" '"$HOME/.claude-shared/auto-rename" "[x] auto-rename swallows the name"' "$TRANSCRIPT"
