...
absolute='/bin/ls'
board_members='"$HOME/.claude-shared/ticket-board-members"'
...
copilot_scripts=(
  ...
  '"$HOME/.claude-shared/cockpit-board-claim" ProjectBoard'
  '"$HOME/.claude-shared/ticket-claim-lock" take abc123'
)
