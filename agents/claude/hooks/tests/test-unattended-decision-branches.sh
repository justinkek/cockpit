...
agents/claude/skills/cockpit:ticket:1:br/SKILL.md
agents/claude/skills/cockpit:epic:0:register/SKILL.md
agents/claude/skills/cockpit:general:problem-solving/SKILL.md
agents/claude/skills/daily-mail/SKILL.md"
...
grep --extended-regexp --quiet "ask when ambiguous|[Aa]sk .*[Tt]ype" \
  "$REPO/agents/shared/skills/cockpit:ticket:0:register/SKILL.md" && asks_for_type="yes"
