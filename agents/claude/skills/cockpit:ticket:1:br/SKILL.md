...
Before writing BR output, read the target section with `"$HOME/.claude-shared/ticket-read" <ticket-url> --section "<heading>"` and check whether it already has content. Exit 7 is the section being absent:
